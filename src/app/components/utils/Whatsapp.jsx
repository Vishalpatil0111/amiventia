...
const WhatsAppButton = () => {
  return (
    ...
    >
      ...
      <span className="absolute right-16 bg-white text-gray-800 text-sm px-3 py-1.5 rounded-lg shadow-md opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none whitespace-nowrap">
        Chat with us
      </span>
    </a>
  );
